module.exports = (sequelize, DataTypes) => {
  const Request = sequelize.define(
    "Request",
    {
      ...
      component:    DataTypes.STRING,   // 🔥 ADDED — used in report form
      ...
      testName:    DataTypes.STRING,    // 🔥 ADDED — used in report form
    ...
    {
      tableName: "requests",
      timestamps: true   // 🔥 ADDED — gives createdAt/updatedAt for archive year filter
    }
  );
