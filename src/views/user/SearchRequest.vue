<template>
  <div class="container mt-4">
    ...
    <h2 class="title">🔍 Search Requests</h2>

    <!-- 🔍 SEARCH FILTERS -->
    <div class="row mb-3">

      <div class="col-md-3">
        <input v-model="filters.requestNo" class="form-control"
          placeholder="Request No" />
      </div>

      <div class="col-md-3">
        <input v-model="filters.partNo" class="form-control"
          placeholder="Part No" />
      </div>

      <div class="col-md-3">
        <input v-model="filters.customer" class="form-control"
  ...
  computed: {
    filteredRequests() {
      return this.requests.filter(r => {
        ...
        return (
          (this.filters.requestNo === "" || (r.requestNo || "").toLowerCase().includes(this.filters.requestNo.toLowerCase())) &&
          (this.filters.partNo === "" || (r.partNo || "").toLowerCase().includes(this.filters.partNo.toLowerCase())) &&
          (this.filters.customer === "" || (r.customer || "").toLowerCase().includes(this.filters.customer.toLowerCase())) &&
          (this.filters.status === "" || r.status === this.filters.status) &&
          (this.filters.fromDate === "" || r.date >= this.filters.fromDate) &&
          (this.filters.toDate === "" || r.date <= this.filters.toDate)
        );
